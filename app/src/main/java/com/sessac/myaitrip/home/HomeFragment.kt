                ...
                if (document != null) {
                    ...
                    viewLifecycleOwner.lifecycleScope.launch {
                        repeatOnLifecycle(Lifecycle.State.CREATED) {
                            homeViewModel.getTourListByContentId(contentIdList, HomeViewModel.ListType.POPULAR)
                        }
                    }
                }
            }
        ...
        Firebase.firestore.collection("tour").document("data").collection("recommend")
            ...
            .addOnSuccessListener { document ->
                if (document != null) {
                    ...
                    viewLifecycleOwner.lifecycleScope.launch {
                        repeatOnLifecycle(Lifecycle.State.CREATED) {
                            homeViewModel.getTourListByContentId(contentIdList, HomeViewModel.ListType.AREA_RECOMMEND)
                        }
                    }
                } else {
                    insertFireBase()
